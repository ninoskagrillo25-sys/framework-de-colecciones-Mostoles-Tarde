...
public class App {
	...
	public static void main(String[] args) {
		...
		* Especificamente, la tuberia son los metodos de la clase Stream que tiene un origen
    	 *  que puede ser una coleccion, un array, un socket de red, etc. tambien tienen cero, 
    	 *  una o varias operaciones intermedia y solamente una operacion terminal, al final
    	 *  de la tuberia, que reducira todos los elementos que van pasando por la tuberia a un
    	 *  solo elemento, o a una nueva coleccion 
