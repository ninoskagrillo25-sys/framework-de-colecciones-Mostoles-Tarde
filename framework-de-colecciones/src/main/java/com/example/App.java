...
public class App {
	...
	public static void main(String[] args) {
		 ...
		 * pasando por la tuberia a un solo elemento, o a una nueva coleccion * Las
		 * Operaciones de Agregado no es una sintaxis bonita, sino el soporte de la JVM
		 * que tienen detras estas operaciones es muy superior a todo lo que
		...
		* personas. */
		...
		personas.stream()
			...
			.ifPresent(System.out::println);/* Ejercicio # 4. 
		* 
		...
		* Recuperar la persona del genero MUJER, que tenga el menor salario*/
		...
		System.out.println("Ejercicio # 4. Persona con el menor salario");
		...
		System.out.println(optionalDePersona.get());
