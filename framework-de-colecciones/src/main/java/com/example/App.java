...
public class App {
	...
	public static void main(String[] args) {
		...
		/*
		 * Existen 3 formas de iterar o recorrer una coleccion, siendo una de ellas la
		 * unica que permite eliminar un elemento de la coleccion mientras se recorre
		 * 
		...
		/*
		 * Crear una lista de Persona, mutable, donde cada Persona sea un record, con
		...
		// List<Persona> listaInmutableDePersona =
		// List.of(persona1,persona1,persona3,persona4, persona5);
		...
		System.out.println("Total de elementos de la coleccion original: " + listaModificableDePersonas.size());
		...
		while (it.hasNext()) {
			...
			if (p.salario().doubleValue() < mediaSalarios.doubleValue() && p.genero().equals(Genero.HOMBRE)) {
				...
				System.out.println("Total de elementos restantes: " + listaModificableDePersonas.size());
